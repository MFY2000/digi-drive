...
class General(tk.Frame):
	def __init__(self, parent, controller, images):
		...
		e1 = tk.Entry(master, width=100, textvariable=uName)
		e2 = tk.Entry(master, width=100, textvariable=pcName)
		...
		arrayOfCheckbox.append(tk.Checkbutton(master, text = "Autmoate check for update"))
		arrayOfCheckbox.append(tk.Checkbutton(master, text = "Automate Upgrade check "))
		arrayOfCheckbox.append(tk.Checkbutton(master, text = "Automate Turn off all usb Port(12 hours)", wraplength=200))
